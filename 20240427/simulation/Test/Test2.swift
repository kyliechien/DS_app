...
class Test2: UIViewController {
    ...
    var qtOpt3:[String] = ["﻿8", "﻿15", "﻿16", "﻿20"]
    var qtOpt4:[String] = ["﻿穩定", "﻿不穩定", "﻿既穩定又不穩定", "﻿取決於輸入數據"]
    var qtOpt5:[String] = ["﻿整數和浮點數", "﻿字串和字符", "﻿任何可比較的數據類型", "﻿僅限整數"]
    
    var questAndAns:[Int:String] = [1:"﻿快速排序", 2:"﻿計數排序", 3:"﻿15", 4:"﻿穩定", 5:"﻿任何可比較的數據類型"]

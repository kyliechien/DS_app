...
class Test4: UIViewController {
    ...
    var qtOpt1:[String] = ["﻿合併排序", "﻿計數排序", "﻿快速排序", "﻿插入排序"]
    var qtOpt2:[String] = ["﻿合併排序", "﻿計數排序", "﻿快速排序", "﻿插入排序"]
    var qtOpt3:[String] = ["﻿5", "﻿9", "﻿10", "﻿15"]
    var qtOpt4:[String] = ["﻿左側", "﻿右側", "﻿這是不確定的", "﻿這是隨機的"]
    var qtOpt5:[String] = ["﻿選擇下一個元素", "﻿將元素插入正確的位置", "﻿交換兩個元素的位置", "﻿確定數列已排序"]
    
    var questAndAns:[Int:String] = [1:"﻿計數排序", 2:"﻿快速排序", 3:"﻿9", 4:"﻿左側", 5:"﻿將元素插入正確的位置"]

...
class Test3: UIViewController {
    ...
    var qtOpt3:[String] = ["﻿0次", "﻿1次", "﻿n次", "﻿n-1次"]
    var qtOpt4:[String] = ["﻿輸入陣列", "﻿輸出陣列", "﻿計數陣列", "﻿中間陣列"]
    var qtOpt5:[String] = ["﻿5", "﻿10", "﻿19", "﻿20"]
    
    var questAndAns:[Int:String] = [1:"﻿計數排序", 2:"﻿快速排序", 3:"﻿n-1次", 4:"﻿計數陣列", 5:"﻿19"]
